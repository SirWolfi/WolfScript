...
namespace IniHelper {
    ...
    namespace tls {
        std::vector<std::string> split_by(std::string str,std::vector<char> erase, std::vector<char> keep = {}, std::vector<char> extract = {}, bool ignore_in_braces = false, bool delete_empty = true, bool lookfor_string = false);
